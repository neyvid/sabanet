        ...
        <section class="col-lg-12 col-md-12">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <h6><b>برای دانلود قالب و دریافت آپدیت های آن به این <a href="http://hosseinizadeh.ir/adminlte">وب
                                سایت</a> مراجعه کنید.</b></h6>
                </div>
            </div>
        </section>
    </div>
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                    <!-- chat item -->
                    <div class="item">
                        <img src="images/admin/user4-128x128.jpg" alt="user image" class="online">
                    ...
                    <!-- chat item -->
                    <div class="item">
                        <img src="images/admin/user3-128x128.jpg" alt="user image" class="offline">
                    ...
                    <!-- chat item -->
                    <div class="item">
                        <img src="images/admin/user2-160x160.jpg" alt="user image" class="offline">
